...
export default function LoginForm({
  ...
  return (
    <div className="w-full max-w-md">
      ...
      {/* Bouton Google avec couleurs officielles */}
      {onGoogleLogin && (
        <button
          type="button"
          onClick={onGoogleLogin}
          disabled={isLoading}
          className="w-full bg-white border border-gray-300 text-gray-700 uppercase tracking-wider py-4 px-8 hover:bg-gray-50 hover:border-gray-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 shadow-sm"
        >
          {/* Logo Google avec couleurs officielles */}
